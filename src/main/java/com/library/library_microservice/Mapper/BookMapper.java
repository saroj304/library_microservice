...
public class BookMapper {
    public Book toBook(BookDto bookDto) {
        return Book.builder()
                .id(UtilityClass.changeNullToEmptyString(bookDto.getId()))
                .title(bookDto.getTitle())
                .author(bookDto.getAuthor())
                .genre(bookDto.getGenre())
                .status(bookDto.getStatus()!=null?bookDto.getStatus(): Book.BookAvailabilityStatus.AVAILABLE)
